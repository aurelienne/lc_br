...
# Run script
#/usr/bin/time -v
singularity run -B /ships22 -B /ships19 -B $HOME/local-TF:$HOME/miniconda3 --nv $CONTAINER python tf_eval_us.py -i /home/ajorge/src/lightningcast-master/lightningcast/static -o /home/ajorge/output_eval_US
