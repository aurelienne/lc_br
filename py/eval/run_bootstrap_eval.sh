...
# Run script
#/usr/bin/time -v
singularity run -B /ships22 -B /ships19 -B $HOME/local-TF:$HOME/miniconda3 --nv $CONTAINER python bootstrap.py -m /home/ajorge/lc_br/data/results/fine_tune_w1.0/full/fit_conv_model.h5 -o /home/ajorge/lc_br/data/results/eval/tuned_LC_w1.0_Full/ -t /ships22/grain/ajorge/data/tfrecs_sumglm/test/2021/ -nt 7
#singularity run -B /ships22 -B /ships19 -B $HOME/local-TF:$HOME/miniconda3 --nv $CONTAINER python bootstrap.py -m /home/ajorge/src/lightningcast-master/lightningcast/static/fit_conv_model.h5 -o /home/ajorge/lc_br/data/results/eval/original_LC/ -t /ships22/grain/ajorge/data/tfrecs_sumglm/test/2021/ -nt 109
