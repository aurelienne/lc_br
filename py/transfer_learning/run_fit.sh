...
# Run script
#/usr/bin/time -v
singularity run -B /ships22 -B /ships19 -B $HOME/local-TF:$HOME/miniconda3 --nv $CONTAINER python tf_fit_newmodel.py -o /ships22/grain/ajorge/data/results/lc_train/ -t /ships22/grain/ajorge/data/results/lc_feat_extraction/train/ -v /ships22/grain/ajorge/data/results/lc_feat_extraction/val
