...
#SBATCH --output=/home/%u/logs/sb_cv_%j.log
...
# Run script
#/usr/bin/time -v
singularity run -B /ships22 -B /ships19 -B $HOME/local-TF:$HOME/miniconda3 --nv $CONTAINER python tf_fit_CV.py -m /home/ajorge/src/lightningcast-master/lightningcast/static -o /home/ajorge/lc_br/data/results/finetune_CV/ -t /ships22/grain/ajorge/data/tfrecs_sumglm/val/2020/ -l conv2d_16 -k 5
