...
# Run script
#/usr/bin/time -v
singularity run -B /ships22 -B /ships19 -B $HOME/local-TF:$HOME/miniconda3 --nv $CONTAINER python tf_predict_baseLC.py -m /home/ajorge/src/lightningcast-master/lightningcast/static -o /ships22/grain/ajorge/data/results/lc_feat_extraction_new/ -t /ships22/grain/ajorge/data/tfrecs_sumglm/train/2020/ -v /ships22/grain/ajorge/data/tfrecs_sumglm/val/2020/
